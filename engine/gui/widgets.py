...
class CompatCTkButton(ctk.CTkButton):
    def __init__(self, *args, bg=None, fg=None, activebackground=None,
                 activeforeground=None, borderwidth=None, relief=None,
                 padx=None, pady=None, bd=None, cursor=None, **kwargs):
        if bg is not None:
...
class CompatCTkFrame(ctk.CTkFrame):
    def __init__(self, *args, bg=None, highlightthickness=None,
                 highlightbackground=None, bd=None, cursor=None,
...
def create_card(parent, title="", bg=None, padx=10, pady=10):
    ...
    return card
def create_button(parent, text, command, bg=None, fg=None,
                  active_bg=None, width=None, height=1, font_size=12):
