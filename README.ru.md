...
- 🔄 **Обновление через Git** — подтягивает только изменения, без повторного скачивания всего архива
...
- **`updater.py`** — обновление через Git: подтягивает только изменения без повторного скачивания всего архива (корректная обработка пробелов в именах файлов через URL-кодирование), самоперезапуск.
